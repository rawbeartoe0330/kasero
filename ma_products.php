	...
	setlocale(LC_MONETARY,"en_US");
      ...
      while($row = mysqli_fetch_array($result)){ 
			...
			echo "<div class='sbox'>";
			 ...
			 echo "<div class='skin'>".$pr_producer."</div> ";	
...
?>
<div id='sep'><h1> Productos Inactivos Temporalmente</h1>	</div>
...
$input = "";
$sql = "SELECT * FROM products WHERE pr_status=0";
	...
	setlocale(LC_MONETARY,"en_US");
      ...
      while($row = mysqli_fetch_array($result)){ 
			...
			echo "<div class='sbox'>";
			 ...
			 echo "<div class='skin'>".$pr_producer."</div> ";	
			echo "<img src='images/".$pr_image1."' alt='".$pr_name."' width='150px	'/>";
			 echo "<div class='stit'>".$pr_name." ".$pr_size." ".$pr_units."</div>";
			//echo "<div class='sum'>".$pr_benefits."</div>";
			//echo " <div class='txt'>".$noticia."</div>";
		   //  echo  " <div class='txt'>".$autor."</div>";
			...
			echo "<a href='product_on.php?id=$pr_id' class='on'>Activar</a>";		
